...
const checkIfAuthenticated = (req, res, next) => {
    ...
    verifyAuthJwtToken(authJwtToken)
        ...
        .catch(err => {
        next((0, http_errors_1.default)(http_status_codes_1.StatusCodes.FORBIDDEN, `${err.message} - Invalid credentials.`));
        return;
    });
};
exports.checkIfAuthenticated = checkIfAuthenticated;
function verifyAuthJwtToken(authJwtToken) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield jwt.verify(authJwtToken, process.env.JWT_SECRET_KEY);
    });
}
